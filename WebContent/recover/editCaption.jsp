...
<body>
	...
	<div class="container center-box shadow-border">
		...
		<h3 class="header-text">RECOVER Dashboard Captions</h3>
    	
 		<sql:query var="caption" dataSource="jdbc/N3CLoginTagLib">
 	       select * from n3c_recover.caption where tag = ?
 	       <sql:param>${param.tag}</sql:param>
		</sql:query>
		<c:forEach items="${caption.rows}" var="row" varStatus="rowCounter">
	    	<form name="caption" method='POST' action='updateCaption.jsp' autocomplete="off" >
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	    				<textarea name="caption" id="caption" cols="50" rows="10">${row.caption}</textarea>
					</div>
	  			</div>
