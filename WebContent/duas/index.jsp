...
<body>
	...
	<div class=" center-box shadow-border">
		<h2 class="header-text">
			<img src="../images/n3c_logo.png" class="n3c_logo_header" alt="N3C Logo">N3C COVID Organization Managment
		</h2>
			...
			<div class="row">
				<div class="col-6">
					...
					<sql:query var="categories" dataSource="jdbc/N3CLoginTagLib">
				        select institutionid, institutionname, substring(duacontactemail from '.*@(.*)') as email
				        from n3c_admin.dua_master
				        where institutionname ~ ?
				          and not exists (select ror_id from n3c_admin.dua_organization where ror_id = institutionid)
				        order by 2;
	...
	<div class=" center-box shadow-border">
		...
		<sql:query var="registration" dataSource="jdbc/N3CLoginTagLib">
	        select institutionid, institutionname, substring(duacontactemail from '.*@(.*)') as email, duaexecuted
	        from n3c_admin.dua_master
	        where institutionid not in (select ror_id from n3c_admin.dua_organization)
	          and duaexecuted is not null
	        order by 2
		</sql:query>
		<table class="table table-hover">
			<thead>
	...
	<div class=" center-box shadow-border">
		...
		<sql:query var="registration" dataSource="jdbc/N3CLoginTagLib">
	        ...
	        from n3c_admin.dua_organization
		</sql:query>
		<table class="table table-hover">
			<thead>
				<tr>
